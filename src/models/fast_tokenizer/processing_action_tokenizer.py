...
class UniversalActionProcessor(ProcessorMixin):
    ...
    def decode(
        ...
        *,
        ...
        for token in tokens:
            try:
                decoded_tokens = self.bpe_tokenizer.decode(token, clean_up_tokenization_spaces=False)
                ...
                if len(decoded_dct_coeff) > expected_len:
                    ...
                    padded[: len(decoded_dct_coeff)] = decoded_dct_coeff
                    decoded_dct_coeff = padded
