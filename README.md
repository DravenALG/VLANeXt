...
## 🚀 Training
ONE [Config](config/libero_train_config.yaml), ONE [Training Code](scripts/train.py), and ONE [Model Code](src/models/VLANeXt.py) for ALL. Below is a brief introduction to the commands used.
